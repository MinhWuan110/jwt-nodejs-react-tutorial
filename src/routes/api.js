...
const initApi = (app) => {
  ...
  router.get("/user/edit/:userid",userApiController.handleGetEdit)
  router.put("/user/edit/:userid",userApiController.handleUpdateUser)


  router.get("/products",userApiController.handleReadProducts)
